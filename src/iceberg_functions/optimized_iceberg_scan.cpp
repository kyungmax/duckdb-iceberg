...
static unique_ptr<TableRef> OptimizedIcebergScanBindReplace(ClientContext &context, TableFunctionBindInput &input) {
...
TableFunctionSet IcebergFunctions::GetOptimizedIcebergScanFunction() {
	...
	auto fun = TableFunction({LogicalType::VARCHAR}, nullptr, nullptr, OptimizedIcebergScanGlobalTableFunctionState::Init);
	fun.bind_replace = OptimizedIcebergScanBindReplace;
